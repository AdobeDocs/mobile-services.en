...
* There is little impact to sending in extra data.
  ...
  These values will not appear in reports until they are mapped using processing rules. For more information, see [Processing Rules and Context Data](/help/android/getting-started/proc-rules.md).
