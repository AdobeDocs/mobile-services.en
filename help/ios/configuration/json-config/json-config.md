...
* **poi**
  ...
  * Minimum SDK version: 4.0
  ...
  If this setting is not configured, the `ADBMobile.json` file must be updated to include this line. To download an updated configuration file, see [Before you start](/help/ios/getting-started/requirements.md). 
