...
>[!IMPORTANT]
>
>The SDK requires iOS 8 or newer.
...
>[!IMPORTANT]
>
>Starting with version 4.21.0, the SDK is distributed via XCFrameworks. If using 4.21.0 or newer, follow the steps below.
>
...
>[!IMPORTANT]
>
>In versions older than 4.21.0, the SDK is distributed via binaries. If using a version older than 4.21.0, follow the steps below.
